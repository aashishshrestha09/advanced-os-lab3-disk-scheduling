...
# Seed random number generator compatibly across Python versions.
...
class Disk:
    ...
    def Animate(self):
        if self.graphics and not self.doAnimate:
...
if options.graphics and _tk_available == False:
    print('Graphics mode requires tkinter, but tkinter is not available in this Python environment.')
    sys.exit(1)
